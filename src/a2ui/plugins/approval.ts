...
import { button, card, readArray, row, text, toRecord } from "../builders/components.js";
import type { SurfacePlugin, SurfacePluginContext } from "./types.js";
...
export function approvalComponents(actions: JsonObject[]): A2UIComponentInstance[] {
