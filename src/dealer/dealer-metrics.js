...
export async function buildDealerMetrics() {
  const [vehicles, leads, orders, finance, repairOrders, warrantyClaims] = await Promise.all([
    loadJson("data/dealer-vehicles.json"),
    loadJson("data/dealer-leads.json"),
    loadJson("data/dealer-sales-orders.json"),
    loadJson("data/dealer-finance.json"),
    loadJson("data/dealer-repair-orders.json"),
    loadJson("data/dealer-warranty-claims.json")
  ]);
...
function buildStoreMetrics({ storeName, vehicles, leads, orders, finance, repairOrders, warrantyClaims }) {
...
function metric({ storeName, category, metric, value, unit, severity, summary, recommendation, related_resource, related_ids }) {
  return {
